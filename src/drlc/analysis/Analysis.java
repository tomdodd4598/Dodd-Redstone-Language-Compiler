...
public interface Analysis extends Switch
{
    ...
    void caseAWildcardRawPattern(AWildcardRawPattern node);
    ...
    void caseABindingPattern(ABindingPattern node);
    void caseAPatternList(APatternList node);
    void caseAPatternListTail(APatternListTail node);
    void caseATuplePatternList(ATuplePatternList node);
    void caseATuplePatternListHead(ATuplePatternListHead node);
    void caseALabelledStructPatternList(ALabelledStructPatternList node);
    void caseALabelledPatternList(ALabelledPatternList node);
    void caseALabelledPatternListTail(ALabelledPatternListTail node);
    void caseALabelledPattern(ALabelledPattern node);
    ...
    void caseAStandardClosurePatternList(AStandardClosurePatternList node);
    void caseALogicalOrClosurePatternList(ALogicalOrClosurePatternList node);
