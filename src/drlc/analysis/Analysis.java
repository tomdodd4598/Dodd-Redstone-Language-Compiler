...
public interface Analysis extends Switch
{
    ...
    void caseALvalueModificationBasicSection(ALvalueModificationBasicSection node);
    ...
    void caseAIntegerNoInitialisationVariableDeclaration(AIntegerNoInitialisationVariableDeclaration node);
    void caseAIntegerWithInitialisationVariableDeclaration(AIntegerWithInitialisationVariableDeclaration node);
    void caseAArrayNoInitialisationVariableDeclaration(AArrayNoInitialisationVariableDeclaration node);
    void caseAArrayWithImplicitInitialisationVariableDeclaration(AArrayWithImplicitInitialisationVariableDeclaration node);
    void caseAArrayWithExplicitInitialisationVariableDeclaration(AArrayWithExplicitInitialisationVariableDeclaration node);
    void caseAIntegerVariableLvalueModification(AIntegerVariableLvalueModification node);
    void caseAArrayElementLvalueModification(AArrayElementLvalueModification node);
    void caseAParArrayElementLvalueModification(AParArrayElementLvalueModification node);
    ...
    void caseAIntegerVariableAddressOfTerm(AIntegerVariableAddressOfTerm node);
    void caseAArrayElementAddressOfTerm(AArrayElementAddressOfTerm node);
    void caseAParArrayElementAddressOfTerm(AParArrayElementAddressOfTerm node);
    void caseAIntegerVariableDereferenceTerm(AIntegerVariableDereferenceTerm node);
    void caseAArrayElementDereferenceTerm(AArrayElementDereferenceTerm node);
    void caseAParArrayElementDereferenceTerm(AParArrayElementDereferenceTerm node);
    void caseAIntegerValue(AIntegerValue node);
    void caseAIntegerVariableValue(AIntegerVariableValue node);
    ...
    void caseARvalueIntegerVariable(ARvalueIntegerVariable node);
    void caseARvalueArrayElement(ARvalueArrayElement node);
    void caseAParRvalueArrayElement(AParRvalueArrayElement node);
    void caseAParRvalueArrayElementInternal(AParRvalueArrayElementInternal node);
    void caseALvalueIntegerVariable(ALvalueIntegerVariable node);
    void caseALvalueArrayElement(ALvalueArrayElement node);
    void caseAParLvalueArrayElement(AParLvalueArrayElement node);
    void caseAParLvalueArrayElementInternal(AParLvalueArrayElementInternal node);
    void caseADeclarationVariable(ADeclarationVariable node);
    void caseAArrayBrackets(AArrayBrackets node);
    void caseAAddressOfImplicitInitialisationArray(AAddressOfImplicitInitialisationArray node);
    void caseADereferenceImplicitInitialisationArray(ADereferenceImplicitInitialisationArray node);
    void caseANestedExplicitInitialisationArray(ANestedExplicitInitialisationArray node);
    void caseANonNestedExplicitInitialisationArray(ANonNestedExplicitInitialisationArray node);
    void caseAExplicitInitialisationArrayList(AExplicitInitialisationArrayList node);
    void caseAExplicitInitialisationArrayListTail(AExplicitInitialisationArrayListTail node);
