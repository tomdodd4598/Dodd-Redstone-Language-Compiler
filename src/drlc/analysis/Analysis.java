...
public interface Analysis extends Switch
{
    ...
    void caseAConditionalStartBlock(AConditionalStartBlock node);
    void caseAConditionalMiddleBlock(AConditionalMiddleBlock node);
    void caseAElseBlock(AElseBlock node);
    void caseALoopIterativeBlock(ALoopIterativeBlock node);
    void caseAConditionalIterativeBlock(AConditionalIterativeBlock node);
    void caseARepeatConditionalIterativeBlock(ARepeatConditionalIterativeBlock node);
    ...
    void caseABuiltInInFunction(ABuiltInInFunction node);
    ...
    void caseTConditionalStartBlockKeyword(TConditionalStartBlockKeyword node);
    void caseTConditionalMiddleBlockKeyword(TConditionalMiddleBlockKeyword node);
    void caseTConditionalIterativeBlockKeyword(TConditionalIterativeBlockKeyword node);
