...
public class PrintNatEdsacRoutine extends EdsacRoutine {
	...
	protected void generateInstructionsInternal() {
		...
		entryText.add(new InstructionDirect("T6F")); // [6]
		...
		entryText.add(new InstructionDirect("T1F")); // [1]
		...
		lowText.add(new InstructionDirect("TF")); // [0]
		...
		breakText.add(new InstructionDirect("U6F")); // [6]
		breakText.add(new InstructionAdd(constantInfo(10000)));
		breakText.add(new InstructionDirect("TF")); // [0]
		breakText.add(new InstructionDirect("O7F")); // [7]
