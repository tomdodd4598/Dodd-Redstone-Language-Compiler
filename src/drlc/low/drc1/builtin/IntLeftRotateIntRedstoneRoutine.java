...
public class IntLeftRotateIntRedstoneRoutine extends RedstoneRoutine {
	
	public IntLeftRotateIntRedstoneRoutine(RedstoneCode code, Routine intermediate) {
	...
	public void generateInstructionsInternal() {
		...
		loadScalar(text, x);
		binaryOp(text, BinaryActionType.NAT_RIGHT_SHIFT_INT, t);
		storeScalar(text, t);
		
		loadScalar(text, x);
		binaryOp(text, BinaryActionType.INT_LEFT_SHIFT_INT, y);
