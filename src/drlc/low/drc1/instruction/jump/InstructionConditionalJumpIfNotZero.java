...
public class InstructionConditionalJumpIfNotZero extends InstructionConditionalJump {
	...
	public String[] toBinary(boolean longAddress) {
		return toBinary(longAddress, RedstoneMnemonics.JNEZ, RedstoneMnemonics.JNEZL);
	}
	
	@Override
	public String toAssembly(boolean longAddress) {
		return toAssembly(longAddress, RedstoneMnemonics.JNEZ, RedstoneMnemonics.JNEZL);
	}
}
