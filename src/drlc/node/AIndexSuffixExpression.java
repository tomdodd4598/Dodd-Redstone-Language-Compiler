...
public final class AIndexSuffixExpression extends PSuffixExpression
{
    ...
    public Object clone()
    {
        return new AIndexSuffixExpression(
    ...
    {
        ((Analysis) sw).caseAIndexSuffixExpression(this);
    }
