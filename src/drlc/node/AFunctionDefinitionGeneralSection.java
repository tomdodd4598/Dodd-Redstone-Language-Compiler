...
public final class AFunctionDefinitionGeneralSection extends PGeneralSection
{
    private PFunctionDefinition _functionDefinition_;

    public AFunctionDefinitionGeneralSection()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFunctionDefinitionGeneralSection(
    ...
    {
        ((Analysis) sw).caseAFunctionDefinitionGeneralSection(this);
    }
