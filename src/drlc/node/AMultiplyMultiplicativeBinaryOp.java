...
public final class AMultiplyMultiplicativeBinaryOp extends PMultiplicativeBinaryOp
{
    private TMultiply _multiply_;

    public AMultiplyMultiplicativeBinaryOp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMultiplyMultiplicativeBinaryOp(
    ...
    {
        ((Analysis) sw).caseAMultiplyMultiplicativeBinaryOp(this);
    }
