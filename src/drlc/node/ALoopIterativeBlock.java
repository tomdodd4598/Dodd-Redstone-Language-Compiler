...
public final class ALoopIterativeBlock extends PIterativeBlock
{
    ...
    public Object clone()
    {
        return new ALoopIterativeBlock(
    ...
    {
        ((Analysis) sw).caseALoopIterativeBlock(this);
    }
