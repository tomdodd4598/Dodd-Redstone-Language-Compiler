...
public final class AArrayListBraceCompoundExpression extends PBraceCompoundExpression
{
    private TLBracket _lBracket_;
    private PExpressionList _expressionList_;
    private TRBracket _rBracket_;

    public AArrayListBraceCompoundExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArrayListBraceCompoundExpression(
    ...
    {
        ((Analysis) sw).caseAArrayListBraceCompoundExpression(this);
    }
