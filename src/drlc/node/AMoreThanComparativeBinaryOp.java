...
public final class AMoreThanComparativeBinaryOp extends PComparativeBinaryOp
{
    private TMoreThan _moreThan_;

    public AMoreThanComparativeBinaryOp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMoreThanComparativeBinaryOp(
    ...
    {
        ((Analysis) sw).caseAMoreThanComparativeBinaryOp(this);
    }
