...
public final class ADeclarationVariable extends PDeclarationVariable
{
    private final LinkedList<TDereference> _dereference_ = new LinkedList<TDereference>();
    private TName _name_;

    public ADeclarationVariable()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADeclarationVariable(
    ...
    {
        ((Analysis) sw).caseADeclarationVariable(this);
    }
