...
public final class ARvalueArrayElement extends PRvalueArrayElement
{
    private TName _name_;
    private final LinkedList<PArrayBrackets> _arrayBrackets_ = new LinkedList<PArrayBrackets>();

    public ARvalueArrayElement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ARvalueArrayElement(
    ...
    {
        ((Analysis) sw).caseARvalueArrayElement(this);
    }
