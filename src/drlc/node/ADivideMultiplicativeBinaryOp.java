...
public final class ADivideMultiplicativeBinaryOp extends PMultiplicativeBinaryOp
{
    private TDivide _divide_;

    public ADivideMultiplicativeBinaryOp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADivideMultiplicativeBinaryOp(
    ...
    {
        ((Analysis) sw).caseADivideMultiplicativeBinaryOp(this);
    }
