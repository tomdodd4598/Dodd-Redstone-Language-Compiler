...
public final class AParenthesesCompoundExpression extends PCompoundExpression
{
    private PParenthesesExpression _parenthesesExpression_;

    public AParenthesesCompoundExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParenthesesCompoundExpression(
    ...
    {
        ((Analysis) sw).caseAParenthesesCompoundExpression(this);
    }
