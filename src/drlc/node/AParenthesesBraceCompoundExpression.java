...
public final class AParenthesesBraceCompoundExpression extends PBraceCompoundExpression
{
    private PParenthesesExpression _parenthesesExpression_;

    public AParenthesesBraceCompoundExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParenthesesBraceCompoundExpression(
    ...
    {
        ((Analysis) sw).caseAParenthesesBraceCompoundExpression(this);
    }
