...
public final class AConditionalStartBlock extends PConditionalStartBlock
{
    private TConditionalStartBlockKeyword _conditionalStartBlockKeyword_;
    ...
    public AConditionalStartBlock()
    {
        // Constructor
    }

    public AConditionalStartBlock(
        @SuppressWarnings("hiding") TConditionalStartBlockKeyword _conditionalStartBlockKeyword_,
    ...
    {
        // Constructor
        setConditionalStartBlockKeyword(_conditionalStartBlockKeyword_);
    ...
    public Object clone()
    {
        return new AConditionalStartBlock(
            cloneNode(this._conditionalStartBlockKeyword_),
    ...
    {
        ((Analysis) sw).caseAConditionalStartBlock(this);
    }

    public TConditionalStartBlockKeyword getConditionalStartBlockKeyword()
    {
        return this._conditionalStartBlockKeyword_;
    }

    public void setConditionalStartBlockKeyword(TConditionalStartBlockKeyword node)
    {
        if(this._conditionalStartBlockKeyword_ != null)
        {
            this._conditionalStartBlockKeyword_.parent(null);
        }
        ...
        this._conditionalStartBlockKeyword_ = node;
    }
    ...
    {
        return ""
            + toString(this._conditionalStartBlockKeyword_)
    ...
    {
        // Remove child
        if(this._conditionalStartBlockKeyword_ == child)
        {
            this._conditionalStartBlockKeyword_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._conditionalStartBlockKeyword_ == oldChild)
        {
            setConditionalStartBlockKeyword((TConditionalStartBlockKeyword) newChild);
            return;
        }
