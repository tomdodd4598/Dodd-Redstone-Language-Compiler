...
public final class ASimpleConditionCompoundExpression extends PConditionCompoundExpression
{
    private PSimpleExpression _simpleExpression_;

    public ASimpleConditionCompoundExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASimpleConditionCompoundExpression(
    ...
    {
        ((Analysis) sw).caseASimpleConditionCompoundExpression(this);
    }
