...
public final class ALvalueArrayElement extends PLvalueArrayElement
{
    ...
    public Object clone()
    {
        return new ALvalueArrayElement(
    ...
    {
        ((Analysis) sw).caseALvalueArrayElement(this);
    }
