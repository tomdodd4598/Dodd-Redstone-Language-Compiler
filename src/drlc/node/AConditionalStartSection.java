...
public final class AConditionalStartSection extends PConditionalStartSection
{
    private TConditionalStartSectionKeyword _conditionalStartSectionKeyword_;
    ...
    public AConditionalStartSection()
    {
        // Constructor
    }

    public AConditionalStartSection(
        @SuppressWarnings("hiding") TConditionalStartSectionKeyword _conditionalStartSectionKeyword_,
    ...
    {
        // Constructor
        setConditionalStartSectionKeyword(_conditionalStartSectionKeyword_);
    ...
    public Object clone()
    {
        return new AConditionalStartSection(
            cloneNode(this._conditionalStartSectionKeyword_),
    ...
    {
        ((Analysis) sw).caseAConditionalStartSection(this);
    }

    public TConditionalStartSectionKeyword getConditionalStartSectionKeyword()
    {
        return this._conditionalStartSectionKeyword_;
    }

    public void setConditionalStartSectionKeyword(TConditionalStartSectionKeyword node)
    {
        if(this._conditionalStartSectionKeyword_ != null)
        {
            this._conditionalStartSectionKeyword_.parent(null);
        }
        ...
        this._conditionalStartSectionKeyword_ = node;
    }
    ...
    {
        return ""
            + toString(this._conditionalStartSectionKeyword_)
    ...
    {
        // Remove child
        if(this._conditionalStartSectionKeyword_ == child)
        {
            this._conditionalStartSectionKeyword_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._conditionalStartSectionKeyword_ == oldChild)
        {
            setConditionalStartSectionKeyword((TConditionalStartSectionKeyword) newChild);
            return;
        }
