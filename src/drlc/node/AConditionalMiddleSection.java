...
public final class AConditionalMiddleSection extends PConditionalMiddleSection
{
    private TConditionalMiddleSectionKeyword _conditionalMiddleSectionKeyword_;
    ...
    public AConditionalMiddleSection()
    {
        // Constructor
    }

    public AConditionalMiddleSection(
        @SuppressWarnings("hiding") TConditionalMiddleSectionKeyword _conditionalMiddleSectionKeyword_,
    ...
    {
        // Constructor
        setConditionalMiddleSectionKeyword(_conditionalMiddleSectionKeyword_);
    ...
    public Object clone()
    {
        return new AConditionalMiddleSection(
            cloneNode(this._conditionalMiddleSectionKeyword_),
    ...
    {
        ((Analysis) sw).caseAConditionalMiddleSection(this);
    }

    public TConditionalMiddleSectionKeyword getConditionalMiddleSectionKeyword()
    {
        return this._conditionalMiddleSectionKeyword_;
    }

    public void setConditionalMiddleSectionKeyword(TConditionalMiddleSectionKeyword node)
    {
        if(this._conditionalMiddleSectionKeyword_ != null)
        {
            this._conditionalMiddleSectionKeyword_.parent(null);
        }
        ...
        this._conditionalMiddleSectionKeyword_ = node;
    }
    ...
    {
        return ""
            + toString(this._conditionalMiddleSectionKeyword_)
    ...
    {
        // Remove child
        if(this._conditionalMiddleSectionKeyword_ == child)
        {
            this._conditionalMiddleSectionKeyword_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._conditionalMiddleSectionKeyword_ == oldChild)
        {
            setConditionalMiddleSectionKeyword((TConditionalMiddleSectionKeyword) newChild);
            return;
        }
