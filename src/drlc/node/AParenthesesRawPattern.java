...
public final class AParenthesesRawPattern extends PRawPattern
{
    private TLPar _lPar_;
    private PPattern _pattern_;
    private TRPar _rPar_;

    public AParenthesesRawPattern()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParenthesesRawPattern(
    ...
    {
        ((Analysis) sw).caseAParenthesesRawPattern(this);
    }
