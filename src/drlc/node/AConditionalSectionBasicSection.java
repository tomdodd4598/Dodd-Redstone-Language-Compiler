...
public final class AConditionalSectionBasicSection extends PBasicSection
{
    private PConditionalSection _conditionalSection_;

    public AConditionalSectionBasicSection()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AConditionalSectionBasicSection(
    ...
    {
        ((Analysis) sw).caseAConditionalSectionBasicSection(this);
    }
