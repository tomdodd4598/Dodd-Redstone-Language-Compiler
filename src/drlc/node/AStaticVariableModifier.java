...
public final class AStaticVariableModifier extends PVariableModifier
{
    private TStatic _static_;

    public AStaticVariableModifier()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AStaticVariableModifier(
    ...
    {
        ((Analysis) sw).caseAStaticVariableModifier(this);
    }
