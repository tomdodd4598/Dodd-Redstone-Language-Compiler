...
public final class APrioritizedConditionAssignmentExpression extends PConditionAssignmentExpression
{
    private PConditionTernaryExpression _conditionTernaryExpression_;

    public APrioritizedConditionAssignmentExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrioritizedConditionAssignmentExpression(
    ...
    {
        ((Analysis) sw).caseAPrioritizedConditionAssignmentExpression(this);
    }
