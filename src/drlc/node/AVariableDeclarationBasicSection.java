...
public final class AVariableDeclarationBasicSection extends PBasicSection
{
    private PVariableDeclaration _variableDeclaration_;

    public AVariableDeclarationBasicSection()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVariableDeclarationBasicSection(
    ...
    {
        ((Analysis) sw).caseAVariableDeclarationBasicSection(this);
    }
