...
public final class APrimaryCompoundExpression extends PCompoundExpression
{
    private PPrimaryExpression _primaryExpression_;

    public APrimaryCompoundExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrimaryCompoundExpression(
    ...
    {
        ((Analysis) sw).caseAPrimaryCompoundExpression(this);
    }
