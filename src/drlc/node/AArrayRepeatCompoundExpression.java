...
public final class AArrayRepeatCompoundExpression extends PCompoundExpression
{
    ...
    public AArrayRepeatCompoundExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AArrayRepeatCompoundExpression(
    ...
    {
        ((Analysis) sw).caseAArrayRepeatCompoundExpression(this);
    }
